...
class FavoriteScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var products = Provider.of<Productss>(context).allproducts().where((element) => element.favorite==true).toList();
    print(products);
    return  Padding(
        ...
        child:GridView.builder(
          ...
          itemBuilder: (ctx, index) => GestureDetector(child: ReuseableCard(ID: products[index].ID, URL:products[index].URL , ProductName: products[index].ProductName,favorite: products[index].favorite,),
